...
public class Employee
{
    ...
    [Column(TypeName = "nvarchar (20)")] public string LastName { get; set; } = null!;

    [Column(TypeName = "nvarchar (10)")] public string FirstName { get; set; } = null!;
    ...
    [Column(TypeName = "int")] public int? ReportsTo { get; set; }
